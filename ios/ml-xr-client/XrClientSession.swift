    ...
    public func getAllAnchors(_ resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        DispatchQueue.main.async { [weak self] in
            ...
            var pcfToPPMap: [String: String] = [
                ...
                "FE355392-A76C-7018-A067-0242C0A8FE0B": "187000B1-3211-FA4E-9350-ADA5CBCCE3A3", // Io
                "FE3530BA-A76C-7018-AF50-0242C0A8FE0B": "1870199D-CF24-49D9-6B8E-28A7EA37B88D", // Atlas
